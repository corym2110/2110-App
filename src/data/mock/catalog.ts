...
export const CATALOG: Product[] = [
  { id: "pt-cory", name: "Personal Training – Cory", category: "Personal Training", price: 115, meta: "1 session", sessionType: "Personal Training" },
  { id: "pt-stu", name: "Personal Training – Stu", category: "Personal Training", price: 125, meta: "1 session", sessionType: "Personal Training" },
  { id: "pt-chris", name: "Personal Training – Chris", category: "Personal Training", price: 130, meta: "1 session", sessionType: "Personal Training" },
  { id: "pt-jhesica", name: "Personal Training – Jhesica", category: "Personal Training", price: 115, meta: "1 session", sessionType: "Personal Training" },
  { id: "pt-cole", name: "Personal Training – Cole", category: "Personal Training", price: 90, meta: "1 session", sessionType: "Personal Training" },
  { id: "pt-group", name: "Group Personal Training", category: "Personal Training", price: 57.5, meta: "Per person", sessionType: "Group Training" },
  { id: "pt-elite", name: "Elite Dryland Training", category: "Personal Training", price: 250, meta: "Program", sessionType: "Personal Training" },
  { id: "consult", name: "Fitness Consult", category: "Personal Training", price: 50, meta: "Single consult", sessionType: "Personal Training" },

  { id: "rem-std", name: "Remote Coaching – Standard", category: "Remote Coaching", price: 189, meta: "Auto-renews", recur: "/month", sessionType: "Remote Consult" },
  { id: "rem-slv", name: "Remote Coaching – Silver", category: "Remote Coaching", price: 249, meta: "Auto-renews", recur: "/month", sessionType: "Remote Consult" },
  { id: "rem-gld", name: "Remote Coaching – Gold", category: "Remote Coaching", price: 299, meta: "Auto-renews", recur: "/month", sessionType: "Remote Consult" },
  { id: "rem-con", name: "Remote Coaching Consult", category: "Remote Coaching", price: 0, meta: "Intro call", sessionType: "Remote Consult" },
  ...
  { id: "cls-10", name: "10 Class Pass", category: "Memberships", price: 200, meta: "10 classes", sessionType: "Class" },
  { id: "cls-drop", name: "Class Drop-In", category: "Memberships", price: 25, meta: "Single class", sessionType: "Class" },
  { id: "cls-free", name: "FREE Class Trial", category: "Memberships", price: 0, meta: "First class", sessionType: "Class" },
  ...
  { id: "bb", name: "Blueprint & Baseline Assessment", category: "Assessments", price: 200, meta: "90 min", sessionType: "Blueprint and Baseline" },
  { id: "bod-1", name: "BodPod – Single", category: "Assessments", price: 75, meta: "Single scan", sessionType: "Bodpod" },
  { id: "bod-3", name: "BodPod – 3 Pack", category: "Assessments", price: 200, meta: "3 scans", sessionType: "Bodpod" },
